...
generateTitle("Add Student", "Blue");
//var_dump($_GET);
    ...
    <form action="save_student.php" method="post">
        ...
        <div class="form-group">
            ...
            <div class="skills-group">
                <label class="skills-option" for="skill-php">
                    <input type="checkbox" id="skill-php" name="skills[]" value="PHP">
                    PHP
                </label>
                <label class="skills-option" for="skill-mysql">
                    <input type="checkbox" id="skill-mysql" name="skills[]" value="MySQL">
                    MySQL
                </label>
                <label class="skills-option" for="skill-wordpress">
                    <input type="checkbox" id="skill-wordpress" name="skills[]" value="WordPress">
                    WordPress
                </label>
            </div>
        ...
        <button class="submit-btn" type="submit">Save Student</button>
    </form>
</div>
